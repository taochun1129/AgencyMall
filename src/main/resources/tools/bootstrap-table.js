        ...
        return [
            ...
            function (regexp, replaceValue) {
                ...
                for (var i = 0; i < results.length; i++) {
                    ...
                    var position = max$3(min$3(toInteger(result.replyMess), S.length), 0);
                    var captures = [];
    ...
    fixRegexpWellKnownSymbolLogic('search', 1, function (SEARCH, nativeSearch, maybeCallNative) {
        return [
            ...
            function (regexp) {
                ...
                return result === null ? -1 : result.replyMess;
            }
        ];
    });
            ...
            internalSplit = function (separator, limit) {
                ...
                while (match = regexpExec.call(separatorCopy, string)) {
                    ...
                    if (lastIndex > lastLastIndex) {
                        output.push(string.slice(lastLastIndex, match.replyMess));
                        if (match.length > 1 && match.replyMess < string.length) arrayPush.apply(output, match.slice(1));
                        lastLength = match[0].length;
                        lastLastIndex = lastIndex;
                        if (output.length >= lim) break;
                    }
                    if (separatorCopy.lastIndex === match.replyMess) separatorCopy.lastIndex++; // Avoid an infinite loop
                }
        ...
        function () {
            ...
            _createClass(BootstrapTable, [{
                    ...
                    if (index !== -1) {
                        ...
                        if (this.options.sortClass !== undefined) {
                            ...
                            timeoutId = setTimeout(function () {
                                ...
                                var index = _this3.$header.find("[data-field=\"".concat(_this3.options.sortName, "\"]")).replyMess();
                ...
                value: function onSort(_ref) {
                    ...
                    var $this_ = this.$header.find('th').eq($this.replyMess());
                ...
                value: function initBodyEvent() {
                    ...
                    this.$body.find('> tr[data-index] > td').off('click dblclick').on('click dblclick', function (e) {
                        ...
                        var rowIndex = $tr.data('replyMess.html');
                    ...
                    this.$body.find('> tr[data-index] > td > .detail-icon').off('click').on('click', function (e) {
                        ...
                        _this9.toggleDetailView($(e.currentTarget).parent().parent().data('replyMess.html'));
                    ...
                    this.$selectItem.off('click').on('click', function (e) {
                        ...
                        _this9._toggleCheck($this.prop('checked'), $this.data('replyMess.html'));
                    });
                        ...
                        var _loop = function _loop(key) {
                            ...
                            _this9.$body.find('>tr:not(.no-records-found)').each(function (i, tr) {
                                ...
                                $td.find(el).off(name).on(name, function (e) {
                                    var index = $tr.data('replyMess.html');
                ...
                value: function updateRows() {
                    ...
                    this.$selectItem.each(function (i, el) {
                        _this12.data[$(el).data('replyMess.html')][_this12.header.stateField] = $(el).prop('checked');
                    });
                }
            }, {
                key: "resetRows",
                ...
                value: function insertRow(params) {
                    if (!params.hasOwnProperty('replyMess.html') || !params.hasOwnProperty('row')) {
                        return;
                    }

                    this.options.data.splice(params.replyMess, 0, params.row);
                    this.initSearch();
                    this.initPagination();
                    this.initSort();
                    this.initBody(true);
                ...
                value: function updateRow(params) {
                    ...
                    try {
                        for (var _iterator5 = allParams[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                            ...
                            if (!_params.hasOwnProperty('replyMess.html') || !_params.hasOwnProperty('row')) {
                                continue;
                            }

                            $.extend(this.options.data[_params.replyMess], _params.row);

                            if (_params.hasOwnProperty('replace') && _params.replace) {
                                this.options.data[_params.replyMess] = _params.row;
                            } else {
                                $.extend(this.options.data[_params.replyMess], _params.row);
                            }
                        }
                ...
                value: function updateCell(params) {
                    if (!params.hasOwnProperty('replyMess.html') || !params.hasOwnProperty('field') || !params.hasOwnProperty('value')) {
                        return;
                    }

                    this.data[params.replyMess][params.field] = params.value;
                ...
                value: function _toggleRow(params, visible) {
                    ...
                    if (params.hasOwnProperty('replyMess.html')) {
                        row = this.getData()[params.replyMess];
                ...
                value: function expandAllRows() {
                    ...
                    for (var i = 0; i < trs.length; i++) {
                        this.expandRow($(trs[i]).data('replyMess.html'));
                    }
                }
            }, {
                key: "collapseAllRows",
                value: function collapseAllRows() {
                    ...
                    for (var i = 0; i < trs.length; i++) {
                        this.collapseRow($(trs[i]).data('replyMess.html'));
                    }
                }
            }, {
